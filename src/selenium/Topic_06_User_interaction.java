...
public class Topic_06_User_interaction {
  ...
  public void TC_00() {
	  ...
	  AssertJUnit.assertTrue(driver.findElement(By.xpath("//div[@class='tooltip-inner' and text()='Hooray!']")).isDisplayed());
  }
  @Test (enabled = false)
  public void TC_00_1() {
	  ...
	  loginIcon.click();
	  AssertJUnit.assertTrue(driver.findElement(By.xpath("//p[@class='login-title']")).isDisplayed());
  }
  ...
  public void TC_01() throws Exception {
	  ...
	  AssertJUnit.assertEquals(4, numberSelected.size());
  }
  @Test (enabled = false)
  public void TC_02() {
	  ...
	  AssertJUnit.assertEquals("The Button was double-clicked", alert.getText());
  }
  @Test (enabled = false)
  public void TC_03() {
	  ...
	  Alert alert = driver.switchTo().alert();
	  AssertJUnit.assertEquals("clicked: quit", alert.getText());
	  alert.accept();
  }
  @Test
  public void TC_04() {
	  ...
	  AssertJUnit.assertTrue(beforeDrag.isDisplayed());
	  ...
	  AssertJUnit.assertTrue(afterDrag.isDisplayed());
